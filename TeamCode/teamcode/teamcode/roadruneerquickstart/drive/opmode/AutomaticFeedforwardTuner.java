package org.firstinspires.ftc.teamcode.roadruneerquickstart.drive.opmode;

import static org.firstinspires.ftc.teamcode.config.DriveConstants.MAX_RPM;
import static org.firstinspires.ftc.teamcode.config.DriveConstants.RUN_USING_ENCODER;
import static org.firstinspires.ftc.teamcode.config.DriveConstants.rpmToVelocity;
...
import org.firstinspires.ftc.teamcode.roadruneerquickstart.util.LoggingUtil;
import org.firstinspires.ftc.teamcode.roadruneerquickstart.util.RegressionUtil;
...
public class AutomaticFeedforwardTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveAuto = new AutonomoSystem(robot.drivetrain, robot.localizationSystem, robot.voltageSensor);
        ...
        driveAuto.setPoseEstimate(new Pose2d());
        ...
        while (!isStopRequested()) {
            ...
            positionSamples.add(driveAuto.getPoseEstimate().getX());
            powerSamples.add(power);

            driveAuto.setDrivePower(new Pose2d(power, 0.0, 0.0));
            driveAuto.updatePoseEstimate();
        }
        driveAuto.setDrivePower(new Pose2d(0.0, 0.0, 0.0));
        ...
        if (fitAccelFF) {
            ...
            driveAuto.setPoseEstimate(new Pose2d());
            driveAuto.setDrivePower(new Pose2d(MAX_POWER, 0.0, 0.0));
